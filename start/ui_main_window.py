...
from PyQt6.QtWidgets import QPushButton, QWidget, QVBoxLayout, QLabel, QHBoxLayout, QSizePolicy, \
    QStatusBar
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        # qss
        MainWindow.setStyleSheet(load_stylesheet("start/assets/styles/style.qss"))
